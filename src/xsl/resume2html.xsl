...
<xsl:stylesheet version="1.0"
      ...
      <xsl:for-each select="resume:SchoolOrInstitution">
        <div class="subSection">
          ...
          <ul class="competencies">
            <li>Major: <xsl:value-of select="resume:Degree/resume:DegreeMajor/resume:Name" /></li>
            <li>Minor: <xsl:value-of select="resume:Degree/resume:DegreeMinor/resume:Name" /></li>
  ...
  <xsl:template match="resume:Qualifications">
    <div class="section">
      <p class="sectionTitle">Volunteer and Club Experience</p>
      <div class="subSection">
        <ul>
          <xsl:for-each select="resume:Competency">
            <li>
